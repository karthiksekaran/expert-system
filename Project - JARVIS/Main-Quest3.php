...
<div class="progress">
<div class="progress-bar" role="progressbar" aria-valuenow="3" aria-valuemin="0" aria-valuemax="100" style="min-width:2em;width: 10%;">
10%
</div>
</div>
</div>
...
$result=mysql_query("alter table ".$row." add q3 varchar(4) NOT NULL",$link);
$insert = mysql_query("update ".$row." set q3=('$quest3') where 1=1", $link);
header('Location:http://localhost/Project - JARVIS/Main-Quest4.php');    
}    
?>
<form action="" method="post" name="query">
<div>
	<p id="demo">
<input type="radio" name="quest3" value="1" onclick="javascript: submit()">Yes
<input type="radio" name="quest3" value="0" onclick="javascript: submit()">No<br></p>
</div>
</div>
<style>
#para
