...
<div class="progress">
<div class="progress-bar" role="progressbar" aria-valuenow="3" aria-valuemin="0" aria-valuemax="100" style="min-width:2em;width: 95%;">
95%
</div>
</div>
</div>
...
<div id="intro-sub">
Question 20: Feeling very tired much of the time
	</div>
	<div id="para">
...
$result=mysql_query("alter table ".$row." add q20 varchar(4) NOT NULL",$link);
$insert = mysql_query("update ".$row." set q20=('$quest20') where 1=1", $link);
header('Location:http://localhost/Project - JARVIS/Rough-Set-Class.php');    
}    
?>
<form action="" method="post" name="query">
<div>
	<p id="demo">
<input type="radio" name="quest20" value="1" onclick="javascript: submit()">Yes
<input type="radio" name="quest20" value="0" onclick="javascript: submit()">No<br></p>
</div>
</div>
<style>
#para
