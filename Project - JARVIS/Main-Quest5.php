...
<div class="progress">
<div class="progress-bar" role="progressbar" aria-valuenow="3" aria-valuemin="0" aria-valuemax="100" style="min-width:2em;width: 20%;">
20%
</div>
</div>
</div>
...
$result=mysql_query("alter table ".$row." add q5 varchar(4) NOT NULL",$link);
$insert = mysql_query("update ".$row." set q5=('$quest5') where 1=1", $link);
header('Location:http://localhost/Project - JARVIS/Main-Quest6.php');    
}    
?>
<form action="" method="post" name="query">
<div>
	<p id="demo">
<input type="radio" name="quest5" value="1" onclick="javascript: submit()">Yes
<input type="radio" name="quest5" value="0" onclick="javascript: submit()">No<br></p>
</div>
</div>
<style>
#para
